...
public class SymbolPointv11 {
	 ...
	 */
	public SymbolPointv11(char c, float x, float y , int line_number) {
		this.setSymbol(c);
		this.setX(x);
		this.setY(y);
	 ...
	 * @param y the y-coordinate
	 */
	public SymbolPointv11(int i, float x, float y,int line_number ) {
		this.setSymbol(i);
		this.setX(x);
		this.setY(y);
		this.setLine_number(line_number);
	 ...
	 */
	public SymbolPointv11(SymbolPointv11 other) {
