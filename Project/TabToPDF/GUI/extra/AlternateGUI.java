...
public class AlternateGUI extends JFrame
{
	...
	public static void addMain(Container panel)
	{
		...
		ImageIcon iconFolder = createImageIcon("res/folder.png");
		ImageIcon iconSettings = createImageIcon("res/settings.png");
		ImageIcon iconConvert = createImageIcon("res/convert.png");
		ImageIcon iconPrint = createImageIcon("res/print.png");
		ImageIcon iconLog = createImageIcon("res/log.png");
