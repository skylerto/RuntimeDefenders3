...
public class GUIModelExtra
{
	...
	private static boolean openFolderIsSelected = false;
	...
	/**
	 * Returns the state of the "Open Containing Folder" check box
	 * 
	 * @return boolean state of the check box
	 */
	public static boolean isOpenFolderSelected()
	{
		return openFolderIsSelected;
	}

	/**
	 * Sets the state of the "Open Containing Folder" check box
	 * 
	 * @param state
	 */
	public static void setOpenFolderSelected(boolean state)
	{
		openFolderIsSelected = state;
	}
