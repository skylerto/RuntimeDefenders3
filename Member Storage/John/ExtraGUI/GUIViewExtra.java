 ...
 * Lines Edited: 90-92; 200-224; 391; 456-459
 */
...
public class GUIViewExtra
{
	...
	{ "ROMAN_BASELINE", "SANS_SERIF", "SERIF" };
	static String[] fontSizesArray =
	{ "8", "10", "12" };
	static String[] spacingArray =
	{ "1", "2", "3", "4", "5" };
	...
	static JLabel resultLabel = new JLabel("Conversion:");
	static JPanel resultPanel;
	static JCheckBox openFolder = new JCheckBox("Open containing folder");
	static JFrame frame;
	 ...
	 * @param panel
	 */
	public static void addBottomPanel(Container panel)
	{
	...
	/**
	 * Method that adds the conversion result and check box
	 * 
	 * @param panel
	 */
	public static void addResultIndicators(Container panel)
	{
		panel.setLayout(new GridBagLayout());
		GridBagConstraints c = new GridBagConstraints();
		...
		c.gridx = 0;
		c.gridy = 0;
		openFolder.setOpaque(false);
		openFolder.setFont(labelFont);
	...
	private static void createAndShowGUI()
	{
		...
		topPanel = new JPanel();
		bottomPanel.setLocation(0, frame.getHeight());
		addBottomPanel(bottomPanel);
		// addLogBox(logPanel);
		addTopBox(topPanel);
		// addEditingPane(editingPanel);
		addResultIndicators(resultPanel);

		logAndButton.add(bottomPanel);
	...
	void addOpenFolderListener(ItemListener listenForSelectButton)
	{
		openFolder.addItemListener(listenForSelectButton);
	}
}
